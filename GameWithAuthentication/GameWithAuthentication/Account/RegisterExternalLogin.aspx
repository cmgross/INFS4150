<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="GameWithAuthentication.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="GameWithAuthentication" %>
